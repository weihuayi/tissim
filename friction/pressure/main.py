...
is_bd_u = uspace.is_boundary_dof((pde.is_ux_Dirichlet, pde.is_uy_Dirichlet), method='interp')
is_bd_p = pspace.is_boundary_dof(pde.is_p_Dirichlet, method='interp')
is_bd = bm.concatenate((is_bd_u, is_bd_p))

p_gd,_ = pspace.boundary_interpolate(pde.p_dirichlet, threshold=pde.is_p_Dirichlet, method='interp')
uin_gd,_ = uspace.boundary_interpolate(pde.u_inflow_dirichlet, threshold=pde.is_left_boundary, method='interp')
gd = bm.concatenate((uin_gd[:], p_gd))
